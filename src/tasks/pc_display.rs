use crate::{
    ...
    CAN_LOCAL_ERROR, CAN_PEER_ALIVE, CanHealth, CanLocalError, INPUT_GPIO_STATUS,
    INTERNAL_STATUS_FLAGS, INTERNAL_STATUS_PHASE, MAIN_VALVE_CLOSED_ANGLE_X10,
...
fn get_can_status_str(peer_alive: bool, local_error: u8) -> &'static str {
    match local_error {
...
pub async fn pc_display_task(mut tx: UartTx<'static, Async>) {
    ...
    loop {
        ...
        let format_result = write!(
            ...
            get_can_status_str(can_peer_alive, can_local_error),
